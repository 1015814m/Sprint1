    ...
    <div class="w3-container" id="administration" style="margin-top: 75px;">
        <form id="feed" runat="server">
            ...
            <table class="table"> 
                 ...
                 <tr>
                     <td class="auto-style1">
                         <asp:Label ID="TotalPoints" Text="&amp;#9899Total Points Earned &lt;br/&gt; &amp;emsp;By Employees:" runat="server"></asp:Label>
                     </td>
                     <td class="auto-style2">
                         &nbsp;</td>
                     <td>
              ...
              <br />
              <asp:TextBox ID="txtWithdrawFrom" runat="server" MaxLength="30"></asp:TextBox>
              <br />
              <asp:Label ID="depositTo" Text="Deposit To:" runat="server"></asp:Label>
              <br />
              <asp:TextBox ID="txtDepositTo" runat="server" MaxLength="30"></asp:TextBox>
              <br />
