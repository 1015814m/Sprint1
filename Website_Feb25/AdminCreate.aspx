    ...
    <!-- Actual Form Code -->
        <form id="feed" runat="server">
             ...
             <div>
                 ...
                 <asp:GridView ID="employeeGrid" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="EmployeeID" DataSourceID="SqlDataSource" OnSelectedIndexChanged="employeeGrid_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None">
                 ...
                 <br />
                 <asp:Button ID="btnSubmit" CssClass="button" runat="server" Text="Submit Changes" formnovalidate="" OnClick="commitChanges" />
                 <asp:Button ID="btnCancel" CssClass="button" runat="server" Text="Cancel" formnovalidate="" OnClick="btnCancel_Click"/>
             </div>       
